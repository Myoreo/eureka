...
public class ExampleEurekaService {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        final EurekaClient eurekaClient = initializeEurekaClient(applicationInfoManager, new DefaultEurekaClientConfig());
...
//        System.setProperty("eureka.vipAddress", "${eureka}.eureka.mydomain.net");
        System.setProperty("eureka.port", "8981");
        System.setProperty("eureka.preferSameZone", "false");
        System.setProperty("eureka.shouldUseDns", "false");
        System.setProperty("eureka.shouldRegisterWithEureka", "false");
